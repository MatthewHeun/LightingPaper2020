...
integration_radiant_flux <- weighted_responses_df %>%
  dplyr::select("Wavelength [nm]", lamp_name, wf_name, actual_radiant_flux, actual_exergy) %>%
  ...
  dplyr::summarise(
    ...
    integrated_rf_X = MESS::auc(x = `Wavelength [nm]`, y = actual_exergy),
    rf_X_div_rf = integrated_rf_X / integrated_rf
  )
...
integration_weighted_radiant_flux <- weighted_responses_df %>%
  dplyr::select("Wavelength [nm]", lamp_name, wf_name, actual_radiant_flux, actual_weighted_radiant_flux, actual_weighted_exergy, actual_exergy) %>%
  ...
  dplyr::summarise(
    ...
    integrated_rf = MESS::auc(x = `Wavelength [nm]`, y = actual_radiant_flux),
    integrated_rf_X = MESS::auc( x = `Wavelength [nm]`, y = actual_exergy),
    integrated_wrf_X = MESS::auc(x = `Wavelength [nm]`, y = actual_weighted_exergy),
    wrf_X_div_wrf = integrated_wrf_X / integrated_wrf,
