...
\del{Average exergy-to-energy ratios~($\bar{\phi}_{L,pl}$) by lamp technology
are given in Table~\ref{tab:mean_phi_p2_by_lamp_type} in the appendix.}
\ins{Table~\ref{tab:mean_phi_p2_by_lamp_type} shows 
...
\del{Average photopic-to-universal conversion factors~($\gammaratavg{}$) by lamp technology
are given in Table~\ref{tab:conversionfactors} in the appendix.}
\ins{Table~\ref{tab:conversionfactors} shows 
...
% by lighting technology.
% 
% <<mean_phi_p2_by_lamp_type_appendix, cache=use_cache, results="asis", cache.extra.2=tools::md5sum('Data/phi_table.R')>>=
% 
% source("Data/phi_table.R")
% 
% # Creates a matrix with each element containing the number of decimal places that the xtable should use.
...
% by lighting technology.
% 
% <<conversionfactors_appendix, cache=use_cache, results="asis", cache.extra.2=tools::md5sum('Data/conversion_table.R')>>=
% 
% source("Data/conversion_table.R")
% 
% # Creates a matrix with each element containing the number of decimal places that the xtable should use.
