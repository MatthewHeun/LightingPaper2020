...
primary energy \ins{carriers} (e.g., coal) \rev{is}{are} converted to
final energy (electricity, measured in watts, W) and lastly to
useful energy (visible light, measured in lumens, lm).
\ins{The field of exergy analysis has long analyzed individual machines
...
\citet{Heun:2019aa}\ins{, and \citet{Ver-Beek:2020aa}} for \del{a }recent example\ins{s}.
