...
<<Conversion_Calcs, cache=use_cache, results="asis", cache.extra.2=tools::md5sum('Data/univ_conversion.R')>>=
...
<<ConversionX_Calcs, cache=use_cache, results="asis", cache.extra.2=tools::md5sum('Data/univX_conversion.R')>>=
