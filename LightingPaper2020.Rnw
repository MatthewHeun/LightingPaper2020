...
\citet{Heun:2019aa}\ins{, and \citet{Ver-Beek:2020aa}} for \del{a }later example\ins{s}
...
Section~\ref{sec:conclusions} summarizes and \rev{concludes}{suggest future work}.
...
Although \del{the }corrected SPDs \del{data }were used for all analyses,
