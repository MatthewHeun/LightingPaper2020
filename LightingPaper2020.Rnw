...
# Creates a matrix containing the number of decimal places that each cell should be rounded to
mdat<-matrix(2,nrow=3,ncol=5); mdat[3,]<-0

print(xtable::xtable(conversion_table, digits=mdat, 
