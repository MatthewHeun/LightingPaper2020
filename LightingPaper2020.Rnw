...
<<Vis_Graph, cache=use_cache, fig.align="center", fig.width = 5, fig.height = 3, fig.cap="Normalized sensitivity and color perception of the human eye to EM radiation~\\cite{schubert2006}, according to the photopic luminous weighting function~($V_\\lambda$).  This figure and Figure~\\ref{fig:wfs_and_lamps} utilize the CIE 10 degree color matching function provided in the \\texttt{R} package \\texttt{ggspectra}~\\cite{Aphalo2015}. 555~nm is the wavelength of peak human eye visibility, \\humaneyesensitivity{} is the range of human retina sensitivity, and 250~nm < $\\lambda$ < 900~nm is the range of data availability for lamp spectral power distributions (SPDs) in the Light Spectral Power Distribution Database (LSPDD)~\\citep{Roby, miguel2017, aube2013}.">>=
response_data %>% 
...
Indeed, societal exergy practitioners 
...
and lesser sensitivities at both 
...
the need for manufacturers to produce blue spikes
of the minimum power possible, 
...
we recommend that an approximate method can be used, 
...
%..............................
\paragraph{Estimating the average exergy-to-energy ratio~($\bar{\phi}_{L,pl}$)} 
%..............................
...
%..............................
\paragraph{Estimating the average photopic-to-universal conversion factor~($\gammaratavg{}$)} 
%..............................
...
%..............................
\paragraph{Implementing the approximate method} 
%..............................
...
so practitioners must weight per-lamp-technology efficiencies
...
For example, such data (and luminous efficacy values, $K_i$)
...
\begin{enumerate*}[label={(\alph*)}]
  ...
  \item uses a spectral exergy-to-energy ratio~($\phi_{L,\lambda}$), and
...
Finally, we provided recommendations for societal exergy practitioners, namely to
%
\begin{enumerate*}[label={(\alph*)}]
