...
(The exergy-to-energy ratio, $\phi$,
is exergy divided by energy at a statepoint.
E.g., $\phi_1 = \dot{X}_1 / \dot{E}_1$.)

The exergy efficiency of an energy conversion device 
...
However, similar to how radiant power is sometimes called ``radiant flux,'' 
...
We selected one representative lamp in the range of 700--950~lm output
