...
<<Weighting_Function_Graph_Exergy, cache.extra=openssl::md5(chroma_type), fig.width=1.5, fig.height=5, cache=TRUE>>=
response_data %>%
...
<<Responses_Graph_Exergy, cache.extra=openssl::md5(chroma_type), fig.width=4.5, fig.height=5, cache=TRUE>>=
response_data %>%
